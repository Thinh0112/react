...
export default class QuanLyDanhSachPhim extends Component {
  ...
  renderFilm = () => {
      return this.dataFilm.map((film,index) => {
        return <div className="col-2 mt-5" key={film.id}>
            <div className="card">
                <img src={film.hinhAnh} alt={film.biDanh} height={300}></img>
  ...
  render() {
    return (
      <div
        style={{
          backgroundImage: "url(./img/background/avanger.jpg)",
      ...
      >
        ...
        >
          <nav className="navbar navbar-expand-sm navbar-dark" style={{backgroundColor:'rgba(100,100,200,0.2)'}}>
