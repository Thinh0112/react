...
export default class Rendering_Conditions extends Component {
  ...
  handleLogin = () => {
    ...
    /**
     * this.setState là phương thức có sẵn của React Class Component dùng để thay đổi giá trị của state. Hàm setSate sẽ nhận vào giá trị state mới và gọi lại hàm render => giao diện thay đổi
